import{d as Y,r as m,c as N,q as Q,h as p,g as e,e as i,w as t,u as r,o as u,f as a,t as h,W as c,a6 as $,F as H,l as X,a7 as _,a as x,a5 as M,b as y,p as J,k as Z}from"./runtime-dom.esm-bundler-9284044f.js";import{M as v,A as C,a as B}from"./kongponents.es-68aab076.js";import{a as ee,z as ae,P as se}from"./production-816b5e57.js";import{S as ne,F as k,E as te}from"./StepSkeleton-7a242f95.js";import{E as le}from"./EnvironmentSwitcher-4f116d39.js";import{f as oe}from"./formatForCLI-931cd5c6.js";import{_ as P}from"./CodeBlock.vue_vue_type_style_index_0_lang-3b59da65.js";import{u as ie}from"./store-0a209cef.js";import{u as re}from"./index-90367807.js";import{Q as de}from"./QueryParameter-70743f73.js";import{_ as ue}from"./_plugin-vue_export-helper-c27b6911.js";import"./toYaml-4e00099e.js";const ce={apiVersion:"v1",kind:"Namespace",metadata:{name:null,namespace:null,annotations:{"kuma.io/sidecar-injection":"enabled","kuma.io/mesh":null}}},l=f=>(J("data-v-f14bf435"),f=f(),Z(),f),pe={class:"wizard"},me={class:"wizard__content"},he=l(()=>e("h3",null,`
          ...
          `,-1)),aa=Y({__name:"DataplaneKubernetes",setup(f){const U=re(),A=`apiVersion: 'kuma.io/v1alpha1'
kind: Dataplane
mesh: default
metadata:
  name: dp-echo-1
    ...
    tags:
      kuma.io/service: echo`,K=[{label:"General",slug:"general"},{label:"Scope Settings",slug:"scope-settings"},{label:"Install",slug:"complete"}],F=[{name:"dataplane"},{name:"example"},{name:"switch"}],q=ee(),S=ie(),z=m(ce),D=m(0),E=m(!1),I=m(!1),b=m(!1),T=m(!1),s=m({meshName:"",k8sDataplaneType:"dataplane-type-service",k8sServices:"all-services",k8sNamespace:"",k8sNamespaceSelection:"",k8sServiceDeployment:"",k8sServiceDeploymentSelection:"",k8sIngressDeployment:"",k8sIngressDeploymentSelection:"",k8sIngressType:"",k8sIngressBrand:"kong-ingress",k8sIngressSelection:""}),w=N(()=>S.getters["config/getTagline"]),W=N(()=>{const d=Object.assign({},z.value),n=s.value.k8sNamespaceSelection;if(!n)return"";d.metadata.name=n,d.metadata.namespace=n,d.metadata.annotations["kuma.io/mesh"]=s.value.meshName;const o=`" | kubectl apply -f - && kubectl delete pod --all -n ${n}`;return oe(d,o)}),j=N(()=>{const{k8sNamespaceSelection:d,meshName:n}=s.value;return n.length===0?!0:D.value===1?!d:!1});Q(()=>s.value.k8sNamespaceSelection,function(d){s.value.k8sNamespaceSelection=ae(d)});const V=de.get("step");D.value=V!==null?parseInt(V):0;function O(d){D.value=d}function G(){I.value=!0}async function L(){const n=s.value.meshName,o=s.value.k8sNamespaceSelection;if(T.value=!1,b.value=!1,!(!n||!o))try{const g=await U.getDataplaneFromMesh({mesh:n,name:o});g&&g.name.length>0?E.value=!0:b.value=!0}catch(g){b.value=!0,console.error(g)}finally{T.value=!0}}function R(){S.dispatch("updateSelectedMesh",s.value.meshName),q.push({name:"data-plane-list-view",params:{mesh:s.value.meshName}})}return(d,n)=>(u(),p("div",pe,[e("div",me,[i(ne,{steps:K,"sidebar-content":F,"footer-enabled":I.value===!1,"next-disabled":r(j),onGoToStep:O},{general:t(()=>[he,a(),e("p",null,`
          ...
          `,1),a(),ve,a(),ke,a(),_e,a(),i(r(v),{class:"my-6","has-shadow":""},{body:t(()=>[i(k,{title:"Choose a Mesh","for-attr":"dp-mesh","all-inline":""},{default:t(()=>[e("div",null,[c(e("select",{id:"dp-mesh","onUpdate:modelValue":n[0]||(n[0]=o=>s.value.meshName=o),class:"k-input w-100"},[ye,a(),(u(!0),p(H,null,X(r(S).getters.getMeshList.items,o=>(u(),p("option",{key:o.name,value:o.name},h(o.name),9,ge))),128))],512),[[$,s.value.meshName]])]),a(),e("div",null,[fe,a(),i(r(C),{to:{name:"create-mesh"},appearance:"outline"},{default:t(()=>[a(`
            ...
            by `+h(r(w))+`.
          `,1)]),example:t(()=>[Ze,a(),ea,a(),i(P,{id:"onboarding-dpp-kubernetes-example",class:"sample-code-block",code:A,language:"yaml"})]),switch:t(()=>[i(le)]),_:1},8,["footer-enabled","next-disabled"])])]))}});const ha=ue(aa,[["__scopeId","data-v-f14bf435"]]);export{ha as default};
