import{A as l,M as h}from"./kongponents.es-68aab076.js";import{u as m}from"./production-816b5e57.js";import{u as b}from"./store-0a209cef.js";import{d as y,c as f,o,h as r,e as c,a4 as g,u as n,w as i,f as e,g as t,t as k,b as p,p as w,k as S}from"./runtime-dom.esm-bundler-9284044f.js";import{_ as x}from"./_plugin-vue_export-helper-c27b6911.js";const u=d=>(w("data-v-f74b1174"),d=d(),S(),d),K={class:"wizard-switcher"},U={class:"capitalize"},E={key:0},z={key:0},I=u(()=>t("p",null,[e(`
            ...
            `)],-1)),q={class:"text-center"},F=y({__name:"EnvironmentSwitcher",setup(d){const s={kubernetes:"kubernetes-dataplane",universal:"universal-dataplane"},_=m(),v=b(),a=f(()=>v.getters["config/getEnvironment"]);return(G,H)=>(o(),r("div",K,[c(n(h),{ref:"emptyState","cta-is-hidden":"","is-error":!n(a),class:"my-6"},g({body:i(()=>[n(a)==="kubernetes"?(o(),r("div",E,[n(_).name===s.kubernetes?(o(),r("div",z,[I,e(),t("p",N,[c(n(l),{to:{name:s.universal},appearance:"secondary"},{default:i(()=>[e(`
                Switch to`),V,e(`
              ...
              `)]),_:1},8,["to"])])])):p("",!0)])):n(a)==="universal"?(o(),r("div",R,[n(_).name===s.kubernetes?(o(),r("div",A,[M,e(),t("p",D,[c(n(l),{to:{name:s.universal},appearance:"secondary"},{default:i(()=>[e(`
                Switch back to Universal instructions
              `)]),_:1},8,["to"])])])):n(_).name===s.universal?(o(),r("div",T,[j,e(),t("p",q,[c(n(l),{to:{name:s.kubernetes},appearance:"secondary"},{default:i(()=>[e(`
                Switch to
                Kubernetes instructions
              `)]),_:1},8,["to"])])])):p("",!0)])):p("",!0)]),_:2},[n(a)==="kubernetes"||n(a)==="universal"?{name:"title",fn:i(()=>[e(`
        Running on `),t("span",U,k(n(a)),1)]),key:"0"}:void 0]),1032,["is-error"])]))}});const X=x(F,[["__scopeId","data-v-f74b1174"]]);export{X as E};
